...
<template>
    <GuestLayout
        ...
        subtitle="Join us and explore authentic traditional wear"
    ...
    >
        ...
        <form @submit.prevent="submit" class="space-y-5">
            <div>
                <InputLabel for="name" value="Full name" class="mb-1.5 font-medium text-gray-700" />
            ...
            <div>
                <InputLabel for="password" value="Password" class="mb-1.5 font-medium text-gray-700" />
            ...
            <div>
                <InputLabel for="password_confirmation" value="Confirm password" class="mb-1.5 font-medium text-gray-700" />
        ...
        <a :href="route('auth.google')" class="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-gray-200 focus:ring-offset-2">
